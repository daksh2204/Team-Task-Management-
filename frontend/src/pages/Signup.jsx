    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl border border-gray-100">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">Join TaskFlow and start managing</p>
        </div>
          ...
          <div className="rounded-md shadow-sm space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="appearance-none rounded-lg relative block w-full px-3 py-2 border border-gray-300 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm mt-1 bg-white"
              >
